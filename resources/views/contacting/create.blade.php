...
<x-admin-dashboard dashTitle='Create Contact'>
    <form method="POST" action="{{route('contacts.store')}}" enctype="multipart/form-data">
        ...
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" name="address" id="form1Example1" class="form-control" />
        ...
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" name="mobile" id="form1Example1" class="form-control" />
            <label class="form-label" for="form1Example1">Mobile</label>
        </div>
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" name="fix_1" id="form1Example1" class="form-control" />
            <label class="form-label" for="form1Example1">Fix.1</label>
        </div>
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" name="fix_2" id="form1Example1" class="form-control" />
            <label class="form-label" for="form1Example1">Fix.2</label>
        </div>
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" name="fix_3" id="form1Example1" class="form-control" />
            <label class="form-label" for="form1Example1">Fix.3</label>
        </div>
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" name="fax" id="form1Example1" class="form-control" />
